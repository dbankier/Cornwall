window.Titanium={};window.Ti=Titanium;//Ti.pageToken=%@;
Ti.appId='com.yydigital.cornwall';

Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;
